...
class ResidualACTPolicy(PreTrainedPolicy):
    """
    Action Chunking Transformer Policy as per Learning Fine-Grained Bimanual Manipulation with Low-Cost
    Hardware (paper: https://huggingface.co/papers/2304.13705, code: https://github.com/tonyzhaozh/act)
    """

    config_class = ResidualACTConfig
    name = "residualact"

    def __init__(
        self,
        config: ResidualACTConfig,
...
class ResidualACT(nn.Module):
    ...
    def __init__(self, config: ResidualACTConfig):
        ...
        # Projection layer for the latent input to the transformer encoder.
    ...
    def forward(self, batch: dict[str, Tensor]) -> tuple[Tensor, tuple[Tensor, Tensor] | tuple[None, None]]:
        ...
        `batch` should have the following structure:
        {
            ...
            [action_feature] (in training) : (B, chunk_size + 1, action dim) batch of (predicted action, target action)
...
class ACTEncoder(nn.Module):
    ...
    def __init__(self, config: ResidualACTConfig, is_vae_encoder: bool = False):
        super().__init__()
